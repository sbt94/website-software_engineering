...
<html>
  ...
  <form action="submitReservation.php" method="post">
    ...
    .then(data => {
        ...
        document.getElementById('customerID').value = customerID;  // set customerID input value
        ...
        console.log('CustomerID:', document.getElementById('customerID').value); // to verify customerID value
    })
    .catch((error) => {
